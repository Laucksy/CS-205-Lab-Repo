...
public:
    ...
    //Varialbes
    char gameboard[ROWS][COLS]; //Char array that contains all the peices
...
private:
    ...
    void remove(int r, int c);        //removes the char in the gameboard and replaces it with ' '


    //   worm Methods
    void defineDirection(); //Turns one digit direction value into a row and col number
