...
public:
    ...
    bool add_row(int id, std::string fName, std::string lName, std::string address);
    bool update(int id, std::string fName, std::string lName, std::string address);
